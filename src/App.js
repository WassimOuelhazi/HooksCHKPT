  ...
  return (
      ...
      <div className="App" >
       ...
       <div className="topbar">
        <button  style={{ backgroundColor:"#FDC600",padding: "10px", margin: "20px" , border:"none"}} onClick={handleShow}>
          {show ? "Close" : "Add a new Movie"}
        </button>
        {show && <AddMovie AddToMovie={AddToMovie} />}

        <Search setSearchName={setSearchName} setSearchRate={setSearchRate} />
        <button style={{ backgroundColor:"#FDC600",padding: "10px", margin: "20px" , border:"none"}}  onClick={handleShowRate}>
